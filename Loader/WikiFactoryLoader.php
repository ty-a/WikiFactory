...
require_once( "$IP/extensions/WikiaFunctions/Wikia.php" );
require_once( "$IP/includes/Defines.php" );
require_once( "$IP/includes/DefaultSettings.php" );
require_once( "$IP/includes/Hooks.php" );
require_once( "$IP/includes/GlobalFunctions.php" );
require_once( "$IP/extensions/WikiaFunctions/GlobalFunctions.php" );
require_once( "$IP/includes/exception/MWException.php" );
require_once( "$IP/includes/db/Database.php" );
require_once( "$IP/extensions/WikiFactory/WikiFactory.php" );
